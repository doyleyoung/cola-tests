...
public class ConditionalIgnoreRule implements MethodRule {
    ...
    public Statement apply(final Statement base, final FrameworkMethod method, final Object target) {
        ...
        if (hasConditionalIgnoreAnnotation(method)) {
            final IgnoreCondition condition = getIgnoreContition(target, method);
    ...
    private static IgnoreCondition getIgnoreContition(final Object target, final FrameworkMethod method) {
    ...
    private static class IgnoreConditionCreator {
        ...
        private void checkConditionType() {
            if (!isConditionTypeStandalone() && !isConditionTypeDeclaredInTarget()) {
                final String msg = "Conditional class '%s' is a member class "
